...
- 자동 확장설 ( Auto Scaling )
  ...
  - 쇼핑몰에서 5월이나 9월에 이벤트를 할때 서버 개수를 늘려서 사용자에 대해 대처를 해야됨
  - 그때 서버 개수는 수작업으로 늘려주었는데 **Auto Scaling**은 자동으로 적용 시켜줌
...
- Continuous deployments
  ...
  - CI/CD 해주는 것
  - 마이크로서비스는 몇천개 이상이 독립적으로 운영될 수 있는데 그때 자동으로 CI/CD를 해주는 것
  - 환경 변화 대응 시간 단축( 파이프라인을 연결해서 )
...
- **12 Factors**
  ...
  12-Factor는 이름에서 보이듯 12가지 항목으로 구성되어있습니다, 이어지는 내용에서는 12가지 항목을 설명하겠습니다. 보다 자세한 내용은 [12facot.net 문서를](https://12factor.net/) 참고하세요.
...
- Monolith
  - 하나의 소프트웨어에 다 포함시켜 개발하는 방식 ( DB로직나 Front 등등 )

## Restful API

![image-20250705152456748](../../images/2025-07-05-cloud-1/image-20250705152456748.png)
